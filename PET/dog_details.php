...
// Fetch the dog details based on the name from the URL parameter
if (isset($_GET['name'])) {
    $dogName =$_GET['name'];
    $sql ="SELECT * FROM dogs WHERE dog_name = '$dogName'";
    ...
    if ($result->num_rows > 0) {
        ...
        $dogAge =$row['dog_age'];
        $dogGender =$row['dog_gender'];
        $healthCondition =$row['dog_health_condition'];
        $dogImageData =$row['dog_image'];
        $details =$row['dog_details'];
    }
...
<html lang="en">
    <head>
        ...
        <title> <?php echo $dogName;?>Details</title>
    <style>
    body {
          overflow-x: hidden;
...
<body>
    <div class="first-part">
        <h1>Ready To Adopt A Dog !</h1>
        <br><br>
        </div>
        <div class="dog-details">
            <img src="data:image/jpeg;base64,<?php echo $dogImageData; ?>" alt="Dog Image">
            <div class="dog-info"></div>
            <div class="adopt1">
                <h2><?php echo $dogName;?></h2>
                <p><strong>Breed:</strong><?php echo $dogBreed;?></p>
                <p><strong>Age:</strong><?php echo $dogAge;?></p>
                 <p><strong>Gender:</strong><?php echo $dogGender;?></p>
            </div>
            <div class="bg">
                <img   src="https://img.freepik.com/premium-vector/paw-prints-dog-footprint-isolated-white-background_101884-1600.jpg"></p>
            </div>
            <div class="adopt">
                <p>Considering <?php echo $dogName;?> for adoption?</p>
                <a href="adoptform.html" class="adopt-button">Adopt <?php echo $dogName;?></a>
            </div>
        </div>
            <div class="about-section"><h3>About <?php echo $dogName;?></h3>
