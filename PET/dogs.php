...
$sql = "SELECT dog_name, dog_image, dog_breed, dog_gender FROM dogs";
...
<body>
    <div class="first-part">
        <h1>Ready To Adopt A Dog!</h1><br><br>
    </div>
    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<a href="dog_details.php?name=' . urlencode($dogName) . '" style="text-decoration: none;  color: white;">';
                echo '<img src="data:image/jpeg;base64,' . $dogImageData . '" alt="Dog Image">';
                echo '<hr>';
                echo '<h3>' . $dogName . '</h3>' ;
                echo '<h4>' . $dogBreed ." . " . $dogGender . '</h4>';
                echo '</div>';
                echo '</div>';
            }
            ?>
