...
$sql = "SELECT cat_name, cat_image, cat_breed, cat_gender FROM cats"; // Changed table and column names
...
<head>
    ...
    <title>Adoptable Cats</title> <!-- Changed title -->
    ...
    <style>
        ...
        .cat-box img {
            width: 160px; /* Set the fixed width */
...
<body>
    <div class="first-part">
        <h1>Ready To Adopt A Cat!</h1><br><br>
    </div>
    ...
    <div class="swiper-container">
        <div class="swiper-wrapper">
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo '<a href="cat_details.php?name=' . urlencode($catName) . '" style="text-decoration: none;  color: white;">';
                echo '<img src="data:image/jpeg;base64,' . $catImageData . '" alt="Cat Image">';
                echo '<hr>';
                echo '<h3>' . $catName . '</h3>' ;
                echo '<h4>' . $catBreed ." . " . $catGender . '</h4>';
                echo '</div>';
                echo '</div>';
            }
            ?>
